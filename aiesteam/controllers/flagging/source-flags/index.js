...
let dbAll = dbSeq.flagging_source_flags
let dbGetSQL = config.sqlGetSourceFlags


const fSourceFlags = {
    flagging_source_flags: {
        name: 'flagging_source_flags',
...
module.exports = {
    ...
    getAll: function (locals, req, res, next) {
        ...
        let whereClause = utils.buildWhereClause(where, fSourceFlags)
      
        where = whereClause.flagging_source_flags.where
