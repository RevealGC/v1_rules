...
// getAll
var ctrl = require('../../../controllers/flagging/source-flags');   //<< MODIFY PER ENTIY
 ...
 */
router.get('/flagging/source-flags', function (req, res, next) {
 ...
 * 
 */
router.get('/flagging/source-flags/:id', function (req, res, next) {
 ...
 * controller
 */
router.post('/flagging/source-flags/', function (req, res, next) {
...
router.put('/flagging/source-flags/:id', function (req, res, next) {
    req.body['updated_by'] = config.defaultUser
    let locals ={}
...
router.delete('/flagging/source-flags/:id', function (req, res, next) {
    let locals ={}
    locals.id = req.params.id
