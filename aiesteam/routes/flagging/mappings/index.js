...
// getAll
var ctrl = require('../../../controllers/flagging/mappings');   //<< MODIFY PER ENTIY
...
var postParams = inputParams.flaggingMappingPost
...
/**
 * GET ALL data flags #15 DONE
 * uses ctrlAllHandler
 * params are defined in the inputParams folder for flaggingGetAll.params
 */
router.get('/flagging/mappings', function (req, res, next) {
 ...
 * 
 */
router.get('/flagging/mappings/:id', function (req, res, next) {
 ...
 * controller
 */
router.post('/flagging/mappings/', function (req, res, next) {
    req.body['created_by'] = config.defaultUser
    req.body['updated_by'] = config.defaultUser
    req.body['deleted_by'] = config.defaultUser
    let locals = req.body
    ctrl.post(locals, req, res, next)
})

/**
 * DONE 
 */
router.put('/flagging/mappings/:id', function (req, res, next) {
    req.body['updated_by'] = config.defaultUser
    let locals ={}
...
router.delete('/flagging/mappings/:id', function (req, res, next) {
    let locals ={}
    locals.id = req.params.id
